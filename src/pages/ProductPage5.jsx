...
import rockingchair from "../assets/Product5.png";
...
const ProductPage = () => {
  ...
  const images = [rockingchair, rockingchair, rockingchair];
        ...
        <div className="left-side">
          <div className="product-image">
            <FaArrowLeft
              ...
              onClick={handlePrev}
            />
            <img src={images[currentIndex]} alt="Luxury Chair" />
            <FaArrowRight
            ...
            <div ref={topRef} id="top" className="scroll-section">
              <div className="product-name-container">
                <div className="product-name">
                  <h1 style={{ color: "#F47D4A" }}>Rocking Chair</h1>
                </div>
                <div>
