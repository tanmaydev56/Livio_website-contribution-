...
import chaiselounge from "../assets/Product3.png";
...
const ProductPage = () => {
  ...
  const images = [chaiselounge, chaiselounge, chaiselounge];
  ...
  return (
    <div className="product-page">
      <div className="product-container">
        <div className="left-side">
          <div className="product-image">
            <FaArrowLeft
              ...
              onClick={handlePrev}
            />
            <img src={images[currentIndex]} width={450}  />
            <FaArrowRight
        ...
        <div className="right-side-container" style={{marginLeft:'2em'}}>
          <div className="right-side">
            <div ref={topRef} id="top" className="scroll-section">
              <div className="product-name-container">
                <div className="product-name">
                  <h1 style={{ color: "#F47D4A" }}>Chaise Lounge</h1>
                </div>
                <div>
