// AccountPageSeller.jsx
import "../styles/AccountPageSeller.css";
...
const accountItems = [
  ...
  },
  {
    ...
    subtext: "Edit login, name and mobile number",
  },
  {
    icon: MapIcon,
    heading: "Addresses",
  ...
  },
  {
    ...
    subtext: "Save on orders through a business account",
  },
  {
    icon: AccountIcon,
    heading: "Payment options",
    subtext: "Edit or add payment methods",
  },
  {
    icon: DataIcon,
    heading: "Manage data",
    subtext: "Manage what we can access",
  },
];
    ...
    <div className="account-container">
      <div className="account-heading">
        ...
        <div className="account-btn-container">
          ...
          <button className="account-btn" onClick={handleDashboard}>Dashboard</button>
        </div>
      </div>
            ...
            <div className="additional-item-content">
              <div className="additional-item-left">
                {item.leftOptions.map((option, i) => (
                  <p key={i} className="additional-item-option">
                    {option}
                  </p>
                ))}
              </div>
